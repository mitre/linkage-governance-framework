...
When appropriate, linking individual-level health data in ways that are secure, compliant and protect privacy allow researchers to accelerate discoveries for prevention, diagnostics, and treatments. The current biomedical research infrastructure lacks a common governance approach that supports linking data for research.  
...
Differing from the current state of governance for linkage, this framework introduces the following concepts for innovation and efficiency:
...
- Simplifying the process for investigators to propose linkage of three or more datasets 
...
In this website you can find a discussion of the challenges linking datasets, description of the framework and its Common Governance Process, examples of how the framework could impact its prospective users, links to framework resources, and information about the project from which this framework was created.
