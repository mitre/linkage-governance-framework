...
3. **Linkage Knowledge Library**: a means to collecting information about the established linkages that can be used for research and the governance that has successfully created new linked data.
