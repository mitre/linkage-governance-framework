...
description: 'What is the Linkage Governance Framework'
permalink: /framework/what-is-framework.html
layout: layouts/page
section: framework
nav: cgf
tags: 
...
Investigators and their Requesting Institutions can use the Linkage Governance Framework when pursuing linkages that involve a high level of complexity. They can expect the framework to facilitate decisions across organizations that grant access and initiate linkage and to help clarify the rules that will apply to the products of linkage (a linked dataset). 
